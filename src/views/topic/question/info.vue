  ...
  <div class="wrapper">
    <el-form ref="form" :model="form" label-width="80px" :rules="rules">
      ...
      <el-form-item label="题目类型" prop="questionEngineId">
        <el-select v-model="form.questionEngineId" placeholder="请选择题目类型">
          <el-option
      ...
      <el-form-item label="难度" prop="level">
        <el-select v-model="form.level" placeholder="请选择试题难度">
          <el-option
      ...
      <el-form-item label="试题内容" prop="content">
        <el-input v-model="form.content" type="textarea" :rows="5" placeholder="请输入试题内容"></el-input>
      </el-form-item>
      <el-form-item>
        <el-button type="primary" @click="onSubmit('form')" v-if="isAdd"
          >立即创建</el-button
        >
        <el-button type="primary" @click="onEdit('form')" v-else
          >修改</el-button
        >
  ...
  data() {
    ...
    return {
      ...
      rules: {
        ...
        level: [{ required: true, message: "请选择试卷难度", trigger: "blur" }],
        content: [
